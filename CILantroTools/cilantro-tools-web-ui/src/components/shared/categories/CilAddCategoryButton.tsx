...
const CilAddCategoryButton: StatelessComponent<
  CilAddCategoryButtonProps
> = props => {
  ...
  const handleFormSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      notistack.enqueueSnackbar(
        translations.categories.errorOccurredWhileAddingCategory,
        {
          variant: 'error'
        }
      );
