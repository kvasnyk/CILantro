...
\englishtitle   {Implementing and testing \fmlinebreak an interpreter of the CIL}
\author         {Kamil Kwaśny}
...
This section follows the informal descriptions contained in \ref{sec:instruction_examples} and uses the conventions described above in order to specify the semantics of several \acrshort{cil} instructions which can be found in formulas \ref{eq:semantics_ldci40}-\ref{eq:semantics_pop}.
...
As mentioned, the main goal of the thesis was to implement an interpreter covering as many \acrshort{cil} instructions as possible.
